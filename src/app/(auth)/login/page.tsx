...
import { Eye, EyeOff, Chrome, Loader2, ArrowLeft } from 'lucide-react';
...
export default function LoginPage() {
  ...
  const handlePasswordRecovery = async (e: React.FormEvent) => {
    e.preventDefault();
    if (!recoveryEmail) {
      toast.error('Introduce tu dirección de correo electrónico.');
      return;
    }
    ...
    if (error) {
      ...
      toast.success('✉️ ¡Correo enviado! Revisa tu bandeja de entrada.');
        ...
        {!recoveryMode ? (
          ...
          <>
            ...
            <form onSubmit={handlePasswordRecovery} className="space-y-4">
              <div>
                <label className="block text-sm text-slate-400 mb-2">Tu Correo Electrónico</label>
                <input
                  type="email"
